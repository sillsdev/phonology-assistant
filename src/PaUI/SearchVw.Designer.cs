namespace SIL.Pa
{
	partial class SearchVw
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlRecentPatterns = new SIL.Pa.PaPanel();
			this.lstRecentPatterns = new System.Windows.Forms.ListBox();
			this.hlblRecentPatterns = new SIL.Pa.HeaderLabel();
			this.btnClearRecentList = new SIL.Pa.XButton();
			this.btnRemoveFromRecentList = new SIL.Pa.XButton();
			this.pnlSavedPatterns = new SIL.Pa.PaPanel();
			this.tvSavedPatterns = new SIL.Pa.SearchPatternTreeView();
			this.hlblSavedPatterns = new SIL.Pa.HeaderLabel();
			this.btnCategoryNew = new SIL.Pa.XButton();
			this.btnCategoryCut = new SIL.Pa.XButton();
			this.btnCategoryPaste = new SIL.Pa.XButton();
			this.btnCategoryCopy = new SIL.Pa.XButton();
			...
			this.ptrnTextBox = new SIL.Pa.PatternTextBox();
		...
		private SIL.Pa.SearchPatternTreeView tvSavedPatterns;
		...
		private SIL.Pa.PaPanel pnlRecentPatterns;
		private SIL.Pa.PaPanel pnlSavedPatterns;
		...
		private SIL.Pa.XButton btnCategoryNew;
		private SIL.Pa.XButton btnCategoryCut;
		private SIL.Pa.XButton btnCategoryCopy;
		private SIL.Pa.XButton btnCategoryPaste;
		...
		private SIL.Pa.HeaderLabel hlblRecentPatterns;
		private SIL.Pa.DockButton btnDock;
		private SIL.Pa.AutoHideButton btnAutoHide;
		private SIL.Pa.HeaderLabel hlblSavedPatterns;
		private SIL.Pa.XButton btnRemoveFromRecentList;
		private SIL.Pa.PatternBuilderComponents ptrnBldrComponent;
		private SIL.Pa.PatternTextBox ptrnTextBox;
		private System.Windows.Forms.Button btnRefresh;
		private SIL.Pa.XButton btnClearRecentList;
	}
}