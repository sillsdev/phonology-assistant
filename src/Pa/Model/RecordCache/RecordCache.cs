...
namespace SIL.Pa.Model
{
	...
	public class RecordCache : List<RecordCacheEntry>, IDisposable
	{
		...
		private void FindAutoGeneratedAmbigousSequences()
		{
			...
			var phoneticField = App.FieldInfo.PhoneticField.FieldName;
		...
		{
			var phoneticField = App.FieldInfo.PhoneticField;
			...
			foreach (var fieldInfo in App.FieldInfo)
			{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		private static void ParseSingleFieldInEntry(RecordCacheEntry entry, PaFieldInfo fieldInfo)
		{
