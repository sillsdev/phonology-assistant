...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="node()|@*">
	...
	<xsl:template match="*[@tuid='Menus and Toolbars.ToolbarItems.SearchOptions_ToolTip_']">
		<xsl:copy>
			<xsl:for-each select="@*">
				<xsl:copy/>
			</xsl:for-each>
			<tuv xml:lang="en">
				<seg>Search Options (Alt+O)</seg>
			</tuv>
		</xsl:copy>
	</xsl:template>
	
	<xsl:template match="*[@tuid='Menus and Toolbars.ToolbarItems.SavePattern_ToolTip_']">
		<xsl:copy>
			<xsl:for-each select="@*">
				<xsl:copy/>
			</xsl:for-each>
			<tuv xml:lang="en">
				<seg>Save Search Pattern (Ctrl+S)</seg>
			</tuv>
		</xsl:copy>
	</xsl:template>
	
	<xsl:template match="*[@tuid='Menus and Toolbars.ToolbarItems.ChartPhoneSearch_ToolTip_']">
		<xsl:copy>
			<xsl:for-each select="@*">
				<xsl:copy/>
			</xsl:for-each>
			<tuv xml:lang="en">
				<seg>Search for Phone (Alt+S)</seg>
			</tuv>
		</xsl:copy>
	</xsl:template>
	
	<xsl:template match="*[@tuid='Menus and Toolbars.ToolbarItems.ShowHistogram_ToolTip_']">
		<xsl:copy>
			<xsl:for-each select="@*">
				<xsl:copy/>
			</xsl:for-each>
			<tuv xml:lang="en">
				<seg>Show Histogram (Alt+H)</seg>
			</tuv>
		</xsl:copy>
	</xsl:template>
	
	<xsl:template match="*[@tuid='Menus and Toolbars.ToolbarItems.ClearChart_ToolTip_']">
		<xsl:copy>
			<xsl:for-each select="@*">
				<xsl:copy/>
			</xsl:for-each>
	...
	<xsl:template match="*[@tuid='Menus and Toolbars.ToolbarItems.DeleteChartRow_ToolTip_']">
		<xsl:copy>
			<xsl:for-each select="@*">
				<xsl:copy/>
			</xsl:for-each>
	...
	<xsl:template match="*[@tuid='Menus and Toolbars.ToolbarItems.DeleteChartColumn_ToolTip_']">
		<xsl:copy>
			<xsl:for-each select="@*">
				<xsl:copy/>
			</xsl:for-each>
