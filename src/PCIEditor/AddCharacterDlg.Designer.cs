namespace SIL.Pa
{
	partial class AddCharacterDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlBinary = new SIL.Pa.PaPanel();
			this.txtBinary = new System.Windows.Forms.TextBox();
			this.hlblBinary = new SIL.Pa.HeaderLabel();
			this.btnBinary = new SIL.Pa.XButton();
			this.paPanel1 = new SIL.Pa.PaPanel();
			this.txtArticulatory = new System.Windows.Forms.TextBox();
			this.hlblArticulatory = new SIL.Pa.HeaderLabel();
			this.btnArticulatory = new SIL.Pa.XButton();
		...
		private SIL.Pa.HeaderLabel hlblArticulatory;
		private SIL.Pa.XButton btnArticulatory;
		private SIL.Pa.PaPanel pnlBinary;
		private System.Windows.Forms.TextBox txtBinary;
		private SIL.Pa.HeaderLabel hlblBinary;
		private SIL.Pa.XButton btnBinary;
