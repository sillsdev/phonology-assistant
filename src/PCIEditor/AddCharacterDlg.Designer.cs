namespace SIL.Pa
{
	partial class AddCharacterDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlBinary = new SIL.Pa.Controls.PaPanel();
			this.txtBinary = new System.Windows.Forms.TextBox();
			this.hlblBinary = new SIL.Pa.Controls.HeaderLabel();
			this.btnBinary = new SIL.Pa.Controls.XButton();
		...
		private SIL.Pa.Controls.HeaderLabel hlblArticulatory;
		private SIL.Pa.Controls.XButton btnArticulatory;
		private SIL.Pa.Controls.PaPanel pnlBinary;
