...
{
	#region PaButtonColumn class
	/// ----------------------------------------------------------------------------------------
	/// <summary>
	/// 
	/// </summary>
	/// ----------------------------------------------------------------------------------------
	public class PaButtonColumn : DataGridViewColumn
	{
		public event DataGridViewCellMouseEventHandler ButtonClicked;
		protected bool m_showButton = true;
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public PaButtonColumn() : base(new PaButtonCell())
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public PaButtonColumn(string name) : this()
		{
			Name = name;
		}
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public PaButtonColumn(string name, bool showButton) : this()
		{
			Name = name;
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public virtual Font ButtonFont
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public virtual bool UseComboButtonStyle
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public virtual bool DrawDefaultComboButtonWidth
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public virtual bool DrawTextWithEllipsisPath
		{
	...
	public class PaButtonCell : DataGridViewTextBoxCell
	{
		...
		/// ------------------------------------------------------------------------------------
		/// <summary>
		/// Gets the cell's owning PaButtonColumn.
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public virtual PaButtonColumn OwningButtonColumn
		{
			get
			{
				...
				return (DataGridView.Columns[ColumnIndex] as PaButtonColumn);
			}
		}
		...
		public virtual bool ShowButton
		{
			get
			{
				...
				return (owningColShowValue && RowIndex >= 0 && row != null && row.Index == RowIndex);
			}
		}
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		public virtual bool IsPointOverButton(Point pt, bool relativeToCell)
		{
		...
		protected override void OnMouseClick(DataGridViewCellMouseEventArgs e)
		{
			...
			PaButtonColumn col =
				DataGridView.Columns[ColumnIndex] as PaButtonColumn;
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		protected virtual void ManageButtonToolTip()
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		protected virtual void DrawButton(Graphics g, Rectangle rcbtn)
		{
			if (!ShowButton)
				return;
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		protected virtual void DrawCellText(Graphics g, string text, DataGridViewCellStyle style,
			Rectangle rcText)
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		protected virtual VisualStyleElement GetVisualStylePushButton()
		{
		...
		/// </summary>
		/// ------------------------------------------------------------------------------------
		protected virtual VisualStyleElement GetVisualStyleComboButton()
		{
		...
		/// ------------------------------------------------------------------------------------
		public virtual void GetRectangles(Rectangle bounds, out Rectangle rcbtn, out Rectangle rcText)
		{
			if (!ShowButton)
			{
			...
			{
				rcbtn.Width -= 2;
				rcbtn.Height = Math.Min(19, rcbtn.Height - 3);
				rcbtn.X++;
				rcbtn.Y += 2;
			}
		}
