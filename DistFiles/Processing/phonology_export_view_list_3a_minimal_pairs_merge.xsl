...
>
  ...
  <!-- phonology_export_view_list_3a_minimal_pairs_merge.xsl 2010-05-03 -->
  ...
  <xsl:template match="@* | node()">
	...
	<xsl:template match="xhtml:tbody[contains(@class, 'group')]" mode="merge">
		...
		<tr class="subheading" xmlns="http://www.w3.org/1999/xhtml">
			<td colspan="2" />
			<xsl:apply-templates select="xhtml:tr[@class = 'heading']/xhtml:th[not(@class = 'Phonetic pair' or @class = 'count')]" />
		</tr>
